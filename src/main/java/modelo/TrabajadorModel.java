...
public class TrabajadorModel {
    private int codtrabajador, edad,telefono,cedula;
    ...
    public TrabajadorModel(int codtrabajador, int edad, int telefono, int cedula, String nombre, String apellido, String direccion, String usuario, String clave, String estado, String tipo_user, Object fechaN) {
